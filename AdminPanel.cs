        ...
        private async void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(Properties.Resources.connectString))
            {
                ...
                try
                {
                    ...
                    //Them Id vao bang hosonhanvin
                    command.CommandText = "INSERT INTO hosonhanvien (idnhanvien_user,hoten,chucvu) VALUES (@user_id,@hoten,@chucvu)";
                    command.Parameters.Clear();
                    command.Parameters.AddWithValue("@user_id", id);
                    command.Parameters.AddWithValue("@hoten", textBox3.Text);
                    command.Parameters.AddWithValue("@chucvu", comboBox1.Text);
                    await command.ExecuteNonQueryAsync();
                    MessageBox.Show("Account was successfully create!");
                }
                catch (Exception ex)
